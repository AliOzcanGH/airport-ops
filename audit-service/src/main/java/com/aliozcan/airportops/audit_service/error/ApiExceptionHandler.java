...
public class ApiExceptionHandler {
    ...
    @ExceptionHandler(PlatformOnlyException.class)
    public ResponseEntity<ErrorResponse> handlePlatformOnly(
            PlatformOnlyException exception, HttpServletRequest request) {
        return errorResponse(
                HttpStatus.FORBIDDEN,
                "PLATFORM_ONLY",
                "This endpoint is only available to platform workspace users",
                request);
    }
