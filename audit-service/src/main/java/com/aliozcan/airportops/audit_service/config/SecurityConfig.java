...
import com.aliozcan.airportops.audit_service.security.IamJwtAuthenticationConverter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/internal/audit-logs").permitAll()
                        .requestMatchers(HttpMethod.GET, "/organizations/*/audit-logs").authenticated()
                        .requestMatchers(HttpMethod.GET, "/platform/audit-logs").authenticated()
                        .anyRequest().denyAll())
