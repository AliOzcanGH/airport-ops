...
import { auditLogsQueryOptions } from '@/features/audit/api/auditLogsQueries'
...
export function AuditLogListPage() {
  const auditLogs = useQuery(auditLogsQueryOptions)

  return (
    <div className="space-y-8">
      <PageHeader
        title="Audit log"
        description="A record of critical actions performed within your organization."
      />
