...
Mini Airport Operations Microservices Lab is a learning-focused backend project for
...
identity-to-IAM mapping, and permission-based endpoint protection. It does not yet
implement complete airport, flight, invitation, Kafka, Redis, or downstream
authorization business flows.
