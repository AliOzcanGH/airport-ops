        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/organizations/*/members")
                                .authenticated()
                        .requestMatchers(HttpMethod.PUT, "/organizations/*/members/*/role")
                                .authenticated()
                        .requestMatchers(HttpMethod.GET, "/app/audit-logs")
                                .authenticated()
                        .requestMatchers(HttpMethod.GET, "/platform/audit-logs")
                                .authenticated()
                        .requestMatchers(HttpMethod.GET, "/app/stations")
                                .authenticated()
                        ...
                        .requestMatchers(HttpMethod.PUT, "/app/stations/*/gates/*/status")
                                .authenticated()
                        .requestMatchers(HttpMethod.GET, "/app/flights")
                                .authenticated()
                        .requestMatchers(HttpMethod.POST, "/app/flights")
                                .authenticated()
                        ...
                        .requestMatchers(HttpMethod.PUT, "/app/flights/*/tasks/*/status")
                                .authenticated()
                        .requestMatchers(HttpMethod.GET, "/app/reports/daily-flights")
                                .authenticated()
                        .requestMatchers(HttpMethod.GET, "/app/reports/gate-utilization")
                                .authenticated()
                        .anyRequest().denyAll()
                )
